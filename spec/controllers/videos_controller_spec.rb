  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved video as @video" do
        ...
        post :create, {:video => { "name" => "invalid value" }}, valid_session
        assigns(:video).should be_a_new(Video)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested video" do
        ...
        Video.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => video.to_param, :video => { "name" => "MyString" }}, valid_session
      end
